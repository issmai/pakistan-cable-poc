...
interface HyperspeedOptions {
  ...
  colors: Colors;
  isHyper?: boolean;
  /** Road and island opacity (0 = fully transparent, 1 = opaque). Default 1. */
  roadOpacity?: number;
}
...
class Road {
  ...
  createPlane(side: number, width: number, isRoad: boolean) {
    ...
    const roadOpacity = options.roadOpacity ?? 1;
    ...
    const material = new THREE.ShaderMaterial({
      ...
      side: THREE.DoubleSide,
      transparent: roadOpacity < 1,
      depthWrite: roadOpacity >= 1,
      uniforms: Object.assign(
        uniforms,
        this.webgl.fogUniforms,
        (typeof options.distortion === 'object' ? options.distortion.uniforms : {}) || {}
